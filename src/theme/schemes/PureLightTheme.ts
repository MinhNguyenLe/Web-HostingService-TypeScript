...
export const PureLightTheme = createTheme({
  ...
  customTheme: {
    hostingCard: {
      bg: customThemeLight.hostingCard.bg,
      txInfor: customThemeLight.hostingCard.txInfor,
      price: customThemeLight.hostingCard.price,
      promotion: customThemeLight.hostingCard.promotion,
      bgSelect: customThemeLight.hostingCard.bgSelect,
      iconTick: customThemeLight.hostingCard.iconTick,
      lineBottom: customThemeLight.hostingCard.lineBottom,
    },
  },
  colors: {
    gradients: {
